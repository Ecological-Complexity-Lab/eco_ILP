...
topoFeatures <- function(edgelist){
  ...
  # centralities
  results = calc_centralities(edgelist_compact[, c('lower_level', 'higher_level', 'weight')], 100)
...
calc_centralities <- function(edge_list, MAX_SIZE) {
  ...
  ## add to results
  return (tibble(cent_between, cent_close, cent_eigen))
}